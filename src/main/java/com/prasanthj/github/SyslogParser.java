 ...
 * Adapted from https://github.com/spotify/flume-syslog-source2 with flume integration removed.
 * This implementation also parses structured data, returns all parsed fields as map and can also un-escape messages.
 *
